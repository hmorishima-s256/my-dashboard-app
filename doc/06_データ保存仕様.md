...
```txt
<ユーザーホーム>/my-dashboard-app/
```

- 共通: `<ユーザーホーム>/my-dashboard-app/_shared/`
- ユーザー別: `<ユーザーホーム>/my-dashboard-app/<url-encoded-email>/`
- Windows例: `C:\Users\<Windowsユーザー名>\my-dashboard-app\`
...
my-dashboard-app/
  _shared/
    ...
    credentials.json (任意: OAuthクレデンシャル)
  <url-encoded-email>/
    token.json
    user-profile.json
    settings.json
